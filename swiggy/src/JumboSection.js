    ...
    return (
        <div className="jumbo">
            ...
            <div className="jumbo_right">
                <img className="jumbo_right_image" style={{marginTop:"-35px"}} src="https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,h_1340/Lunch1_vlksgq" />
            </div>
        </div >
    )
}
